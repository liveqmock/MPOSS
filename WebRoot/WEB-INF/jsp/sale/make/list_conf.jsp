...
<form id="pagerForm" method="post" action="/sale/make/listConf">
	...
	<table class="list" width="100%" layoutH=110">
		...
		<tbody>
			...
			<tr>
			    ...
			    <td>${myfn:getConstantName('DEPOSIT_FLAG', sale.depositFlag)}</td>
			    <td>${sale.receMen}</td>
			    ...
			    <td><a class="button" href="/sale/make/conf/${sale.saleId}" title="销售确认" mask="true" target="dialog" width="950" height="600"><span>销售确认</span></a></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
