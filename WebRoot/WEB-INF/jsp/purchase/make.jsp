...
<div class="pageContent">
	<form method="post" action="/purchase/insert?navTabId=purchase_make" class="pageForm required-validate" onsubmit="return Pur.validateCallback(this,navTabAjaxDone,'你确定提交采购单吗？')">
		<input type="hidden" name="purchaseProp" value="2"/><!-- PURCHASE_PROP(2-库存采购) -->
		...
		<div layoutH="37" class="nowrap">
		    <div style="padding:10px;height:30px;">
			    ...
			    <a bind="custom" style="float:left;margin-left:3px;" class="button" href="#" target="dialog" mask="true" rel="sale_make_product" width="900" height="600"><span>添加采购产品</span></a>
		    </div>
			<div style="clear:both;"></div>
			<table class="list" width="80%" style="background:url(${sessionOper.logoImg}) left top no-repeat;">
				<thead>
					<tr>
					...
					<tr>
						<th colspan="9" style="font-size:16px;height:30px;font-weight:bold;">采购订货单</th>
					</tr>
					<tr>
						<th>合同编号：</th>
						<th></th>
...
$(document).ready(function(){
    $("a[target='dialog']", navTab.getCurrentPanel()).click(function(event){
	    ...
	    if(Pur.purProviderId != null){
	        if(providerId != Pur.purProviderId){
	    ...
	    $this.attr("href","/purchase/goods?provider.providerId="+providerId);
