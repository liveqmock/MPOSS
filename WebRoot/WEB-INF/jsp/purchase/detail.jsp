    ...
    <div layoutH="37" class="nowrap">
		...
		<table class="list" width="100%" style="background:url(${sessionOper.logoImg}) left top no-repeat;">
			<thead>
				...
				<tr>
					<th colspan="11" style="height:30px;">Add（地址）: ${sessionOper.address}</th>
				</tr>
				<tr>
					<th colspan="11" style="font-size:16px;height:30px;font-weight:bold;">采购订货单<br/>${purchase.purchaseNo}</th>
				</tr>
				<tr>
					<th>合同编号：</th>
		...
		<table class="list" width="100%" style="background:url(${sessionOper.logoImg}) left top no-repeat;">
			...
			<tbody>
			    ...
			    <c:choose>
			    <c:when test="${busiType=='03' && arrivalDetail.arrivalDetailId == targetLeafId}">
