...
<div class="pageHeader">
	<form id="pagerForm" onsubmit="return divSearch(this, 'sale_list');" action="/partner/consumer/consumeDetail/${consumerId}" method="post">
...
<div class="pageContent">
	<table class="list" width="100%" layoutH="367">
		<thead>
		    <tr>
			    <th colspan="9" style="font-weight:bold;">客户交易数据</th>
			</tr>
			<tr>
			    <th>日期</th>
			    <th>产品型号</th>
	...
	<div class="panelBar">
		<div class="pages">
			<span>显示</span>
			<select class="combox" name="numPerPage" onchange="navTabPageBreak({numPerPage:this.value}, 'sale_list')">
		...
		<div class="pagination" rel="sale_list" targetType="navTab" totalCount="${totalCount}" numPerPage="${numPerPage}" pageNumShown="10" currentPage="${param.pageNum}"></div>
	</div>
</div>