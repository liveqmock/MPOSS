...
if($this.isTag("table")){
$this.removeAttr("layoutH").wrap('<div layoutH="'+iLayoutH+'" style="overchange:auto;height:'+iH+'px"></div>');}else{
$this.height(iH).css("overchange","auto");}});},
...
return this.optional(element)||/^[0-9 A-Za-z]+$/.test(value);},"Digits and letters only please");
...
options.toShow.css({overchange:"auto"});
options.complete();}});},
...
$this.css({overchange:"visible",position:"relative"});
...
$this.css({overchange:"visible",position:"relative",height:"0px"})
.animate({height:fixedHeight},{
duration:op.duration,
easing:op.easing,
complete:function(){$this.css({display:"",overchange:""});op.call();}});
